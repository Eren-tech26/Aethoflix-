  ...
  private updateCamera(dt: number) {
    ...
    if (this.overview) {
      ...
      this.desiredCamera.set(
        seat.x * (0.96 - zoom * 0.08),
        seat.elevation + 2.42 - zoom * 0.12,
        Math.min(6.97, seat.z + 2.46 - zoom * 0.72),
      );
      this.desiredTarget.set(0, 2.52 + zoom * 0.08, -6.83);
      ...
      targetFov = portrait ? Math.max(zoom ? 58 : 77, seatedVerticalFov) : (zoom ? 34 : 46);
    } else {
